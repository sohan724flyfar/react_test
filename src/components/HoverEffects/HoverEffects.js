  ...
  return (
    <div className="customHover">
      ...
      <p>
        ←{" "}
        <a
          href="https://www.nxworld.net/css-image-hover-effects.html"
          target="_blank"
          rel="noreferrer"
        >
          View the article
      ...
      <div className="column">
        ...
        <div>
          <figure>
            <img src="https://picsum.photos/300/200?image=1024" alt="..." />
          </figure>
          <span>Hover</span>
        </div>
        <div>
          <figure>
            <img src="https://picsum.photos/300/200?image=611" alt="..." />
          </figure>
          <span>Hover</span>
        </div>
      </div>
